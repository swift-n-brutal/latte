# -*- coding: utf-8 -*-
"""
Created on Thu Dec 01 21:37:06 2016
...
def test2(deploy, model=None, net=None,
    ...
    if test_interval != None:
        ...
        testset = latte.CifarDataLoader(osp.join(CAFFE_ROOT, 'examples', 'cifar10/cifar10_test_lmdb'),
                                        ...
                                        data_blob=data_blob, label_blob=label_blob)
        test_net.set_dataloader(testset)
        test_loss = []
        test_top1 = []
    else:
        test_net = None
        testset = None
    solver = latte.NewtonSolver(net, test_net)
    #
    loss = []
    top1 = []
    trans = []
